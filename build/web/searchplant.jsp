...
<html>
    ...
    <body>
        <header>
            <nav>
                <ul>
                    ...
                    <li><a href="viewCart1.jsp">View Cart</a></li>
                    <i class="fa fa-arrow"></i>
                    <li>
        ...
        <%
            ...
            ArrayList<Plant> list = (ArrayList) request.getAttribute("listofitems");
        ...
        <table class="order">
            ...
            <tr>
                ...
                <td>
                    ...
                    if(pla.getStatus() == 1){
                    %>
                    <a href="KeyKeeper?action=addToCart1&pid=<%= pla.getId() %>&status=<%= pla.getStatus() %>">Add to your cart</a>
                    <%
                    }
                    %>
                </td>
