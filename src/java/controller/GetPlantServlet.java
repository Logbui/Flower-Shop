            ...
            if(p != null){
                if(action != null){
                    switch(action){
                        ...
                        case "updatePlant":
                            request.setAttribute("PlantObj", p);
                            //request.setAttribute("UpdatePlant", action);
                            request.getRequestDispatcher("KeyKeeper?action=UpdatePlant").forward(request, response);
                            //response.sendRedirect("updatePlant.jsp");
                            break;
                    }
                }
            }
