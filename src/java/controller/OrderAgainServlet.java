...
public class OrderAgainServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<OrderDetail> listOrdersDetail = OrderDetailDAO.getOrderDetail(Integer.parseInt(orderId));
            HashMap<Integer, Cart> subCarts = new HashMap<>();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrderAgainServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
